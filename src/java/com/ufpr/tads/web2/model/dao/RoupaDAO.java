...
public class RoupaDAO {
    ...
    public RoupaDAO(Connection connection) {
      this.connection = connection;
    }

    public List<Item> listarRoupas() throws DAOException{
    ...
    public void inserirRoupa(Item roupa) throws DAOException{
    ...
    public void atualizarRoupa(Item roupa) throws DAOException{
    ...
    public void deletarRoupa(int id)  throws DAOException{
